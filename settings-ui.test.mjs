...
function harness(){
 ...
 const context=vm.createContext({window:{CREW_MOBILE:false},URL,WeakSet,Date,
  ...
  createSkillsUI:()=>({open:async()=>{featureCalls.push('skills');}}),createLearningReviewUI:()=>({open:async()=>{featureCalls.push('learning');}}),createRecallUI:()=>({open:async()=>{featureCalls.push('recall');}}),createIntegrationsUI:()=>({open:async()=>{featureCalls.push('integrations');}}),createNotificationsUI:()=>({open:async()=>{featureCalls.push('notifications');}}),createFallbackUI:()=>({open:async()=>{featureCalls.push('fallback');}}),createRoutinePolicyUI:()=>({open:async()=>{featureCalls.push('routine');}}),
