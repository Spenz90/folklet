...
import {createReliabilityUI} from './reliability-ui.mjs';
import {createHostingUI} from './hosting-ui.mjs';
export function createSettingsUI({api,modal,refresh,getBots,accountPanel,md,onSource,onAppChange,draftStorage,onDraftChange}){
 ...
 const reliabilityUI=createReliabilityUI({api,modal,draftStorage,onDraftChange});
 ...
 function guideText(text){
  const known=new Set(['QUICKSTART.md','HOSTING.md','PROVIDERS.md','FEATURES.md','SECURITY.md','RELEASE-CHECKS.md','FEATURE-ROADMAP.md','PLUGINS.md','RECOVERY.md']),links=[];
 ...
 const screens={reliability:()=>reliabilityUI.open(),host:hostingUI.open,models:modelUI.listBots,connections:providers,learning:learningUI.open,skills:skillsUI.open,plugins:pluginsUI.open,recall:recallUI.open,integrations:integrationsUI.open,notifications:notificationsUI.open,computer,cloud,welcome};
