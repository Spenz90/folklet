...
export function createSettingsUI({api,modal,refresh,getBots,accountPanel,md,onSource,onAppChange}){
 ...
 async function providers(){
  clearTimeout(oauthTimer);if(window.CREW_MOBILE){modal('Connections','Manage accounts on your host computer.','<p class="note">You can choose an existing connection for each bot here. Add accounts or API keys from the computer or private server running Crew.</p>','connections');return;}modal('Connections','Choose the account or API that powers your bots.','<div id="provider-list">Loading connections…</div>','connections');const target=$('provider-list'),view=$('modal-error');
