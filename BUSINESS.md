...
Before quoting a real plan, measure CPU/RAM/storage use, concurrent browser demand, API usage, backup and recovery cost, payment fees, taxes and human support time. Check current infrastructure prices directly with providers. Do not advertise unlimited work, unlimited models or a consumer subscription resale arrangement.

## What must exist before selling it

- A tested private deployment and update process, dedicated tenant isolation, reliable backups and a demonstrated restore.
- Clear account/key ownership, retention/deletion rules, export tools, incident handling and an honest privacy policy.
- Real provisioning, metering, resource limits, billing, cancellation and support. An attractive pricing page is not those systems.
