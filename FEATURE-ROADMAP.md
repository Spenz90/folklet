# Crew 0.6: from ideas to features
...
“Hermes” means Nous Research's Hermes Agent; “Clawbot” was interpreted as OpenClaw. Their documentation informed the ideas below. Crew implements its own bounded versions and does not import their executable plugins or promise feature parity.

| Feature | Included in 0.6 | Deliberate limits |
| --- | --- | --- |
| **Reusable skills** | Instruction documents with steps, examples, a checklist, revisions, review, per-bot enabling and Crew JSON import/export. | Accepted and enabled are separate choices. Imports remain pending. Skills cannot install code or grant permissions. |
